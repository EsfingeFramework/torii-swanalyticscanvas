...
const Projects = () => {
    ...
    const [imgUrl, setImgUrl] = React.useState('https://i.redd.it/38aeu51hq3d61.jpg');
    ...
    const addProject = (e) =>{
        e.preventDefault()
        const project={"pname":projName,"description":description,"imgUrl":imgUrl,"members":members}
    ...
    const apiAllData = "http://localhost:8080/api/project/"+sessionStorage.getItem('username');
    ...
    return(
        <div>
            <Center>
                <Typography variant="h2" component="h2"  style={{marginTop:"2%", fontWeight:"bold", letterSpacing: 10, color:"#02db93"}} >
                    Projects
                </Typography>
            </Center>
            <Center>
                <IconButton color="primary" aria-label="upload picture" component="span" style={{marginTop:"1%", marginBottom:"3%"}} onClick={() => setOpenedM(true)}>
