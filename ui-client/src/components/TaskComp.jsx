...
const TaskComp = (props) => {
    ...
    const updateTask = (e) =>{
        e.preventDefault()
        const subTask={"id":id, "description":description,"date":date,"deadline":deadline,"members":members,"complete":complete,"connected":connected,  "pId":pId,"generated":false,"issue":false,"measure":false,"tool":false,"high":false,"insight":false,"goal":false,"decision":hasIssue }
          ...
          >
              <Card.Section>
                  <Group position="apart" style={{marginTop:"3%"}}>
                      <Avatar color="cyan" size="sm" style={{marginLeft:"3%"}}>Mr</Avatar>
                      <Text weight={500}>{date}</Text>
                      <Menu opened={openedM} onOpen={handlers.open} onClose={handlers.close} transition="rotate-right" style={{marginRight:"3%"}}>
                          ...
                          <Menu.Item onClick={() => {setOpened(true)}}>Edit Task</Menu.Item>
                          <Menu.Item color="red" onClick={deleteData}>Delete Task</Menu.Item>
                      </Menu>
                  </Group>
              </Card.Section>
              <Card.Section component="b" style={{cursor: "pointer", marginTop:"1%",marginLeft:"2%",marginRight:"2%", marginBottom:"0.1%"}} onClick={() => { routeChange("/subtasks")}}>
                  <Title align="center" order={3}>{description}</Title>
                  <br/>
                  <Progress value={complete} color={ complete === 100 ? "green" : "yellow"} radius="xl" size="sm" />
                  ...
                  <div hidden={!openedDetails}>
                      ...
                      <Center>
                              <RingProgress
                                  ...
                                  label={
                                      <div>{complete1 === 100 ? <Center><DoneIcon style={{color:"#37b34e"}} sx={{ fontSize: 70 }}/></Center> : <Center><AutorenewIcon style={{color:"#f09400"}} sx={{ fontSize: 70 }}/></Center>}</div>
                                  }
                      ...
                      <Center style={{marginTop:"10%"}} >
                          <Group position="center">
                              ...
                              <Text size="lg" style={{marginBottom:"3%"}}>Pending: {complete3}%</Text>
                          </Group>
                      </Center>
                          ...
                          if(get.status===('pending') && get.category === 'issue')
                              return(
                                  <div style={{marginTop:"4%"}}>
                                      <Center>
                                          <Badge color="teal" radius="sm">{get.category}</Badge>
                                      </Center>
                                      <Center>
                      ...
                      {gets.map((get,index) => {
                        ...
                        <Center style={{marginTop:"10%"}} >
                              <Group position="center">
                                  ...
                                  <Text size="lg" style={{marginBottom:"3%"}}>Planned: {complete2}%</Text>
                              </Group>
                        </Center>
                      {gets.map((get,index) => {
                      ...
                      <Center style={{marginTop:"10%"}} >
                          <Group position="center">
                              ...
                              <Text size="lg" style={{marginBottom:"3%"}}>No Pendency: {complete1}%</Text>
                          </Group>
                      </Center>
                      ...
                      {gets.map((get,index) => {
                          if(get.status===('No Pendency') && get.category === 'measurements')
                              return(
                                  <div style={{marginTop:"4%"}}>
                                      <Center>
                                          <Badge color="teal" radius="sm">{get.category}</Badge>
              ...
              >
                  ...
                  />
                  <br/>
                  <DatePicker placeholder={value} inputFormat={"DD-MMM-YYYY"} label="Deadline" value={value} onChange={setValue} />
                  <br/>
                  <Center>
