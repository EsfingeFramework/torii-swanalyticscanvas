...
const ProjectTest= () => {
    ...
    const addSubTask = (e) =>{
        e.preventDefault()
        const subTask={"category":category,"description":description,"color":color,"status":status,"members":members,"complete":parseInt(complete),"date":date, "deadline":deadline, "pId":pId, "tId":tId}
    ...
    const apiAllData = "http://localhost:8080/api/subTask/"+"t629499eaf09387747e3449ed";
    ...
    return(
        <Box  sx={{ flexGrow: 1 }}>
            ...
            >
                ...
                />
                <br/>
                <TextInput label="Status" placeholder="Your email" defaultValue={status} onChange={handleStatusChange}/>
                <br/>
                <Center>
